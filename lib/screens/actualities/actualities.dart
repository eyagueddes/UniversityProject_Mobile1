...
class _actualitiesState extends State<actualities> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        create: (BuildContext context) => SchoolCubit()..getActualities()..getUserData(),
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      Container(
                                        ...
                                        "${cubit.allActualities[index]['image']}":'https://delta-expert.fr/wp-content/uploads/2017/11/cest-nouveau-2-272x185.png',
