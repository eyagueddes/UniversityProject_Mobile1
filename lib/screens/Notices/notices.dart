                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  text('Avis', textColor: appStore.textPrimaryColor, fontSize: textSizeLarge, fontFamily: fontBold),
                                ],
                              ),
                            ),
                            ListView.builder(
                                  ...
                                  return Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        Row(
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: SvgPicture.asset(assetNotice,color: white,),
                                            ),
                                            SizedBox(width: 16),
                                            Column(
                                              crossAxisAlignment:
                                                ...
                                                Row(
                                                  children: [
                                                    Text('Sujet: ',
                                                        style:
                                                        primaryTextStyle()),
                                                    text(cubit.allNotices[index]['title'],maxLine: 1,
                                                        textColor:
                                                        appStore.textPrimaryColor,
                                                        fontSize: textSizeSMedium),
                                                  ],
                                                ),
                                                (cubit.allNotices[index]['pdf']!="") ?
                                                TextButton(
                                                  child: text(  'Téléchager',
                                                      fontFamily: fontMedium,fontSize: textSizeSmall,textColor: logosColors),
                                                  onPressed: (){
                                                    print('notice to download,${cubit.allNotices[index]['pdf']}');
                                                    cubit.downloadNotice(cubit.allNotices[index]['pdf']);
                                                  },
                                                ):Text(''),
                                              ],
                                            )
                                        ...
                                        //         style:
                                        //         primaryTextStyle()),
                                        //     Text(cubit.allNotices[index]['message'],
